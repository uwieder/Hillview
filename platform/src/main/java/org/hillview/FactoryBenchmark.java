...
public class FactoryBenchmark {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        PrintWriter writer = new PrintWriter("FactoryBenchmarkDense", "UTF-8");

        for (skipSize = 2000; skipSize < 10001; skipSize += 1000) {
            final DoubleArrayColumn col = HistogramBenchmark.generateDoubleArray(colSize, 100);
            ITable table = createDenseTable(colSize, col, skipSize);
